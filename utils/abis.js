const BATCH_QUERY = [
	{
		...
		"name": "batchQueryReservesConfiguration",
		"outputs": [
			{
	...
	},
	{
		...
		"name": "uniswapV2PairsBatchQuery1",
		"outputs": [
			{
				"internalType": "address[]",
				"name": "",
